...
function Pricing() {
    ...
    return (
        <div className='min-h-screen bg-gray-100 px-6 py-10 relative'>
            <button onClick={() => navigate("/")} className='flex items-center gap-2 text-gray-600 hover:text-black mb-6'>⬅ Back</button>
            <motion.div
            ...
            >
                <h1 className='text-4xl font-bold text-gray-800 mb-4'>Buy Credits</h1>
                <p className='text-gray-600 text-lg'>Choose the plan that's right for you</p>
            ...
            <div className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6'>
                ...
                <PricingCard
                    ...
                    features={[
                        ...
                        "More credits per rupees",
                        "Recision mode access",
...
function PricingCard({
    ...
    setSelectedPrice,
    onBuy,
    paying,// paying meanse user is paying for this plan
    payingAmount //payingAmount means amount user is paying
    ...
    return (
     ...
     bg-white border transition ${isSelected ? "border-black " : popular ? "border-indigo-500" : "border-gray-200"}`}>
