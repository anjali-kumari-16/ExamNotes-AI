...
function Home() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black">
      ...
      {/* top*/}
      <section
        className="max-w-7xl mx-auto px-8 pt-32 grid 
      grid-cols-1 lg:grid-cols-2 gap-20 items-center"
      >
        <div>
          <motion.div
          ...
          >
            <motion.h1
              className="text-5xl lg:text-6xl font-extrabold leading-tight bg-gradient-to-br from-black/90 via-black/90
          bg-clip-text text-transparent"
           ...
           to-gray-700 bg-clip-text text-transparent "
            ...
            >
              Generate exam-focused notes ,project documentation, flow diagram
              and revision-ready content using AI -faster diagram and
      ...
      md:grid-cols-4 gap-10">
        <Feature icon="📘" title="Exam Notes" des="High-yield exam-oriented notes." />
        <Feature icon="📁" title="Project Notes" des="Well-structured content for assignments and projects." />
        <Feature icon="📊" title="Diagrams Notes" des="Auto-generated visual diagrams for clarity." />
        <Feature icon="⬇" title="PDF Download" des="Download clean, printable PDFs instantly." />
      </section>
      <Footer />
    </div>
  );
